...
public class copyAutoTestGiaiDau {
...
//                String inputTextAnsBStr = "Dap An B...";
        ...
        WebElement buttonQuanLyTranDau2 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div/div/div/div[1]/div[4]/main/div/div/div/div[2]/div/div[1]/div/div[2]/div/div[4]")));
        buttonQuanLyTranDau2.click();
        WebElement buttonThemTranDau2 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div/div/div/div[1]/div[4]/main/div/div/div/div[2]/div/div[2]/div/div[2]/div/div/div[1]/button/span/span")));
        buttonThemTranDau2.click();
        sleep(1000);
        WebElement inputTextTenTranDau2 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("tournament-match_form-name")));
        inputTextTenTranDau2.sendKeys("Tran Dau 2");
        WebElement inputTextOnGTranDau2 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("tournament-match_form-ong")));
        inputTextOnGTranDau2.sendKeys("0");
        WebElement inputTextDiemTranDau2 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("tournament-match_form-score")));
        inputTextDiemTranDau2.sendKeys("10");
        WebElement inputTextTenDoi12 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("tournament-match_form-team1")));
        inputTextTenDoi12.sendKeys("Doi 1");
        WebElement inputTextTenDoi22 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("tournament-match_form-team2")));
        inputTextTenDoi22.sendKeys("Doi 2");
        WebElement buttonThoiGian2 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("tournament-match_form-time")));
        buttonThoiGian2.click();
        sleep(500);
        WebElement buttonChooseDay152 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='v-btn__content' and text()='15']")));
        buttonChooseDay152.click();
        WebElement buttonOKThoiGian2 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[@class='v-btn__content' and text()='OK']")));
        buttonOKThoiGian2.click();
        WebElement buttonLogoDoi12 = chromeDriver.findElements(By.className("v-file-input__text")).get(1);
        buttonLogoDoi12.click();
        sleep(2000);
        screen.type("\"C:\\Users\\admin\\Desktop\\imageSup\\1.jpg\"");
        screen.type(Key.ENTER);
        sleep(1000);
        WebElement buttonLogoDoi22 = chromeDriver.findElements(By.className("v-file-input__text")).get(2);
        buttonLogoDoi22.click();
        sleep(2000);
        screen.type("\"C:\\Users\\admin\\Desktop\\imageSup\\3.jpg\"");
        screen.type(Key.ENTER);
        sleep(1000);
        WebElement buttonLuuTranDau2 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("tournament-match_form-submit_btn")));
        buttonLuuTranDau2.click();
        WebElement buttonQuanLyCauHoiDuDoan2 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div/div/div/div[1]/div[4]/main/div/div/div/div[2]/div/div[1]/div/div[2]/div/div[8]")));
        buttonQuanLyCauHoiDuDoan2.click();
        WebElement inputTextQuestion2 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div/div/div/div[1]/div[4]/main/div/div/div/div[2]/div/div[2]/div/div[4]/div/div/div[2]/div/div/div/div/div[2]/div[1]/div/form/div/div[2]/div/div[2]/div/div/div[1]/div/textarea")));
        String inputTextQuestionStr2 = "Cau hoi dau tri 2";
        inputTextQuestion2.sendKeys(inputTextQuestionStr2);
        WebElement inputTextAnsA2 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div/div/div/div[1]/div[4]/main/div/div/div/div[2]/div/div[2]/div/div[4]/div/div/div[2]/div/div/div/div/div[2]/div[1]/div/form/div/div[2]/div/div[3]/div[1]/div/div/div[1]/div/input")));
        String inputTextAnsAStr2 = "Dap An A... 2";
        inputTextAnsA2.sendKeys(inputTextAnsAStr2);

        WebElement inputTextAnsB2 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div/div/div/div[1]/div[4]/main/div/div/div/div[2]/div/div[2]/div/div[4]/div/div/div[2]/div/div/div/div/div[2]/div[1]/div/form/div/div[2]/div/div[3]/div[2]/div/div/div[1]/div/input")));
        String inputTextAnsBStr2 = "Dap An B... 2";
        inputTextAnsB2.sendKeys(inputTextAnsBStr2);
        WebElement inputTextOnG2 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div/div/div/div[1]/div[4]/main/div/div/div/div[2]/div/div[2]/div/div[4]/div/div/div[2]/div/div/div/div/div[2]/div[1]/div/form/div/div[3]/div/div[2]/div/div[1]/div/input")));
        inputTextOnG2.sendKeys("0");
        WebElement buttonLuu2 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div/div/div/div[1]/div[4]/main/div/div/div/div[2]/div/div[2]/div/div[4]/div/div/div[2]/div/div/div/div/div[2]/div[1]/div/form/div/div[5]/button/span")));
        buttonLuu2.click();
        WebElement buttonDieuKhieu2 = chromeDriver.findElements(By.className("text-none")).get(5);
        buttonDieuKhieu2.click();
        sleep(1000);
        WebElement buttonChooseMatch = chromeDriver.findElements(By.className("v-select__slot")).get(5);
        buttonChooseMatch.click();
//        WebElement buttonChooseMatch = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div/div/div/div[1]/div[4]/main/div/div/div/div[2]/div/div[2]/div/div[3]/div/div/div[1]/div[2]/div/div[1]/div[1]/input[1]")));
//        buttonChooseMatch.click();
        actions.sendKeys(Keys.ARROW_DOWN, Keys.ENTER);
        WebElement buttonThemCauHoi2 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div/div/div/div[1]/div[4]/main/div/div/div/div[2]/div/div[2]/div/div[3]/div/div/div[3]/div[2]/div/div[1]/div/div[1]/div/button/span/i")));
        buttonThemCauHoi2.click();
        sleep(2000);
        WebElement checkBoxThemCauHoi2 = chromeDriver.findElements(By.className("v-input--selection-controls__ripple")).get(3);
        checkBoxThemCauHoi2.click();
        WebElement buttonLuuThemCauHoi2 = chromeDriver.findElements(By.className("v-btn__content")).get(79);
        buttonLuuThemCauHoi2.click();
        WebElement buttonBanCauHoi2 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div/div/div/div[1]/div[4]/main/div/div/div/div[2]/div/div[2]/div/div[3]/div/div/div[3]/div[2]/div/div[1]/div/div[2]/div/div/div/table/tbody/tr/td[4]/div/div/button[3]/span/i")));
        buttonBanCauHoi2.click();
        if (chromeDriver.getTitle().equals("minhdn211002 | ON Live")) {
            WebElement buttonOpenDauTri = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[1]/div[2]/div/div[1]/div[1]/div/div[2]/div[24]/div")));
            buttonOpenDauTri.click();
            sleep(2000);
...
//                String inputTextAnsBStr = "Dap An B...";
            ...
            String outputTextQuestion = outputQuestion.getText();
            System.out.println(outputTextQuestion);
            Assert.assertEquals(outputTextQuestion, "1. " + inputTextQuestionStr2.toUpperCase());

            WebElement outputAnsA = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("ans-0")));
            String outputTextAnsA = outputAnsA.getText();
            System.out.println(outputTextAnsA);
            Assert.assertEquals(outputTextAnsA, inputTextAnsAStr2.toUpperCase());

            WebElement outputAnsB = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("ans-1")));
            String outputTextAnsB = outputAnsB.getText();
            System.out.println(outputTextAnsB);
            Assert.assertEquals(outputTextAnsB, inputTextAnsBStr2.toUpperCase());
